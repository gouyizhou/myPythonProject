...
if __name__ == '__main__':
    ...
    for index in range(1, homePages.__len__()):
        # print("index:",index)
        # print('Now website is %s' %(homePages[index]))
        # 当前主页面的所有视频标题
        ...
        # for i in range(0, completeUrls.__len__()):
        #     print("titles:", titles[i])
        #     print("signal links:",signalLinks[i])
